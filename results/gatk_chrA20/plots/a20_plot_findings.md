...
![Windowed FST across chromosome A20](a20_windowed_fst_100kb.png)

**File:** `a20_windowed_fst_100kb.png`
...
![Mean absolute allele-frequency difference across chromosome A20](a20_windowed_af_difference_100kb.png)

**File:** `a20_windowed_af_difference_100kb.png`
...
**File:** `a20_top_af_differences.png`
...
![PCA of red and black samples using chromosome A20 SNPs](a20_pca_red_black.png)

**File:** `a20_pca_red_black.png`
...
![SNP density across chromosome A20](a20_snp_density_100kb.png)

**File:** `a20_snp_density_100kb.png`
...
![Variant summary for chromosome A20](a20_variant_summary.png)
